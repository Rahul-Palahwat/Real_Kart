...
const Filter: React.FC <Props>= (props) => {
  ...
  return (
    <div>
      ...
      <Flex direction={"column"} height={"100vh"} mt={"8vh"} ml={5}>
        <Flex width={"20vw"} height={"33vh"} className="filter" direction={"column"}>
          <Flex height={"20%"} alignItems="center" ml="3" fontSize={"medium"} fontWeight="bold" borderBottom={"1px solid grey"} mb={3}>
            ITEMS
          </Flex>
        ...
        <Flex width={"20vw"} height={"33vh"} className="filter" direction={"column"}>
          ...
          <RadioGroup>
            <Flex direction={"column"} ml={3}>
              <Checkbox isDisabled value='1' mb={5} >5% & above</Checkbox>
              <Checkbox isDisabled value='2' mb={5}>10% & above</Checkbox>
              <Checkbox isDisabled value='3' mb={5}>25% & above</Checkbox>
              <Checkbox isDisabled value='4' mb={5}>50% & above</Checkbox>
            </Flex>
          </RadioGroup>
        </Flex>
